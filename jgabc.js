...
for(var char, code = 0xE0E0; code < 0xFFFF; code += 16) {
  ...
  var data = "d";
	...
	style.appendChild(document.createTextNode("@font-face {font-family: 'Caeciliae Staffless'; font-weight: normal; font-style: normal;src: local(Caeciliae Staffless); src:url(Caeciliae-staffless.ttf) format(opentype)}" +
