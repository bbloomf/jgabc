...
var regexWords = /((?:<[a-záéíóúýäëïöüÿąćçęłńśźż]+>)*)([^a-záéíóúýäëïöüÿąćçęłńśźż\(\)\<]*\s*"*(?=\b|[(<]))(([a-záéíóúýäëïöüÿąćçęłńśźż’'*]*)(?:\(([a-záéíóúýäëïöüÿąćçęłńśźż’'*]+)\)([a-záéíóúýäëïöüÿąćçęłńśźż’'*]*))?)(=?)([-"'“”‘’:;,.\)\?!]*)(\s+[†*])?((?:<\/[a-záéíóúýäëïöüÿąćçęłńśźż]+>\s*)*)/gi;
