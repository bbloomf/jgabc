                ...
                return function(result){
                  ...
                  result.on('end',function(){
                    ...
                    if(isMiscChant) {
                      ...
                      miscChants.push({name: h.name.replace(/A[Ee]/g,'Æ').replace(/ae/g,'æ').replace(/O[Ee]/g,'Œ').replace(/oe/g,'œ'), id: ids[i]});
                    }
                    ...
                    content = content.replace(/<sp>'(?:ae|æ)<\/sp>|aé/g,'ǽ')
                      ...
                      .replace(/\s*((?:<sp>v\/<\/sp>\.?\s*)?\d+\.)(\(::z?\))\s*/gi,' $2\n$1 ')
                      .replace(/\s*(<sp>[vra]\/<\/sp>\.?\s*)\(\)\s*/gi,' $1 ')
                      .replace(/\s*(<sp>[vra]\/<\/sp>\.?\s*)(\(::z?\))\s*/gi,' $2\n$1 ')
                      .replace(/(\w)(\([^)]+\)\s+):/g,'$1:$2')
                      .replace(/[/ ]+\)/g,')')
                      .replace(/(\(:+z?\))\s+/gi,'$1\n');
