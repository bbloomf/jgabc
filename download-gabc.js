...
let gabc2719 = [];
let write2719part = (gabc, i) => {
  if (i > 1) {
    gabc = gabc.replace(/^[\s\S]+?\(c4\)\s*/, '');
  }
  gabc2719[i - 1] = gabc;
  if (gabc2719.filter(val => !!val).length === 5) {
    fs.writeFileSync(path + '2719.gabc', gabc2719.join('\n\n'));
  }
}
var callbackOn = {
  ...
  1092: write1092,
  "2719&elem=1": gabc => write2719part(gabc, 1),
  "2719&elem=2": gabc => write2719part(gabc, 2),
  "2719&elem=3": gabc => write2719part(gabc, 3),
  "2719&elem=4": gabc => write2719part(gabc, 4),
  "2719&elem=5": gabc => write2719part(gabc, 5),
}
