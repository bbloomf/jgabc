...
var commonsKeys = [
    {title:"Commune Sanctorum...",en:"Commons of Saints..."},
    {key:"mass_vigil_apostle",title:"In Vigiliis Apostolorum (Ego autem sicut)",en:"Mass Vigil of an Apostle (Ego autem sicut)"},
    {key:"mass_holy_pope",title:"Commune Summorum Pontificum (Si diligis me)",en:"Mass of a Holy Pope (Si diligis me)"},
    {group:true, title:"Commune unius Martyris Pontificis",en:"Common of a Martyr-Bishop"},
    {key:"mass_i_martyr_bishop",title:"Missa I (Statuit)",en:"Mass I (Statuit)"},
    {key:"mass_ii_martyr_bishop",title:"Missa II (Sacerdotes Dei)",en:"Mass II (Sacerdotes Dei)"},
    {group:true, title:"Commune unius Martyris non Pontificis",en:"Common of a Martyr not a Bishop"},
    {key:"mass_i_martyr_not_bishop",title:"Missa I (In virtute tua)",en:"Mass I (In virtute tua)"},
    {key:"mass_ii_martyr_not_bishop",title:"Missa II (Laetabitur justus)",en:"Mass II (Laetabitur justus)"},
    {group:true, title:"Commune Martyrum Tempore Paschali",en:"Common of Martyrs in Paschal Time"},
    {key:"mass_one_martyr",title:"Pro uno Martyre (Protexisti me)",en:"One Martyr (Protexisti me)"},
    {key:"mass_two_or_more_martyr",title:"Pro pluribus Martyribus (Sancti tui)",en:"Two or more Martyrs (Sancti tui)"},
    {group:true, title:"Commune plurimorum Martyrum",en:"Common of two or more Martyrs"},
    {key:"mass_i_two_or_more_martyr",title:"Missa I (Intret in conspectu)",en:"Mass I (Intret in conspectu)"},
    {key:"mass_ii_two_or_more_martyr",title:"Missa II (Sapientiam sanctorum)",en:"Mass II (Sapientiam sanctorum)"},
    {key:"mass_iii_two_or_more_martyr",title:"Missa III (Salus autem)",en:"Mass III (Salus autem)"},
    {group:true, title:"Commune Confessoris Pontificis",en:"Common of a Confessor Bishop"},
    {key:"mass_i_confessor_bishop",title:"Missa I (Statuit)",en:"Mass I (Statuit)"},
    {key:"mass_ii_confessor_bishop",title:"Missa II (Sacerdotes tui)",en:"Mass II (Sacerdotes tui)"},
    {key:"mass_doctors",title:"Pro Doctoribus (In medio)",en:"Doctors (In medio)"},
    {group:true, title:"Commune Confessoris non Pontificis",en:"Common of a Confessor not a Bishop"},
    {key:"mass_i_confessor_not_bishop",title:"Missa I (Os justi)",en:"Mass I (Os justi)"},
    {key:"mass_ii_confessor_not_bishop",title:"Missa II (Justus ut palma)",en:"Mass II (Justus ut palma)"},
    {key:"mass_abbots",title:"Pro Abbatibus (Os justi)",en:"Abbots (Os justi)"},
    {group:true, title:"Commune Virginum",en:"Common of Virgins"},
    {key:"mass_i_virgin_martyr",title:"Pro Virgine et Martyre I (Loquebar)",en:"Virgin Martyr, Mass I (Loquebar)"},
    {key:"mass_ii_virgin_martyr",title:"Pro Virgine et Martyre II (Me exspectaverunt)",en:"Virgin Martyr, Mass II (Me exspectaverunt)"},
    {key:"mass_i_virgin_not_martyr",title:"Pro Virgine tantum I (Dilexisti)",en:"Virgin not a Martyr, Mass I (Dilexisti)"},
    {key:"mass_ii_virgin_not_martyr",title:"Pro Virgine tantum II (Vultum tuum)",en:"Virgin not a Martyr, Mass II (Vultum tuum)"},
    {group:true, title:"Commune non Virginum",en:"Common of Holy Women"},
    {key:"mass_holy_woman_martyr",title:"Pro Martyre (Me exspectaverunt)",en:"Martyr (Me exspectaverunt)"},
    {key:"mass_holy_woman_not_martyr",title:"Pro nec Virgine nec Martyre (Cognovi)",en:"Neither Virgin nor Martyr (Cognovi)"},
];
var saintKeys = [
...
var proprium = {
    ...
    "mass_ii_two_or_more_martyr": {
        ...
        "coID": 699,
        "coRef": "Luc 12: 4",
        "gbid": "mass_ii_two_or_more_martyr",
        "isUsed": true
    },
    "mass_ii_virgin_not_martyr": {
        ...
        "gbid": "mass_ii_virgin_not_martyr",
        "isUsed": true
    },
    "mass_holy_pope": {
